...
export const dmMachine: MachineConfig<SDSContext, any, SDSEvent> = {
  initial: 'idle',
    ...
    help2: {
      id:"help2",
      entry: say(`Hi! You need to confirm if you want or not meet them?`),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
    help3: {
      id:"help3",
      entry: say('Hi! Tell me what is your meeting! For example lunch, doctor, workout...'),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
    help4: {
      id:"help4",
      entry: say('Hi! On which day of the week is your meeting? Do not forget to say on before the day. For example on monday.'),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
    help5: {
      id:"help5",
      entry: say('Hi! I need to know if you will be busy with this meeting during the whole day or just for period of time.'),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
    help6: {
      id:"help6",
      entry: say('Hi! I need to know when your meeting starts.'),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
    help7: {
      id:"help7",
      entry: say('Hi! I just need you to confirm if all the informations about your meeting are correct.'),
      on: {
          ENDSPEECH: 'help.hist'
      }
    },
      ...
      Date: {
        ...
        on: {
          RECOGNISED: [
            {
              target: "Day",
              cond: (context) => !!getEntity(context, "day") && context.recResult[0].confidence > 0.8,
              actions: assign({
            ...
            prompt2: {
              entry: [assign({ count: 3 })],
                    ...
                    states: {
                      ...
                      entry: send((context) => ({
                        type: "SPEAK",
                        value: `${context.name}, would you like to create the meeting ${context.title} on ${context.day} for the whole day?`
                      })),
                      on: { ENDSPEECH: "ask" },
                },
                ask: {
            ...
            prompt3: {
              entry: [assign({ count: 4 })],
                    ...
                    states: {
                      ...
                      entry: send((context) => ({
                        type: "SPEAK",
                        value: `Last chance! Am I creating the meeting ${context.name}?`
                      })),
                      on: { ENDSPEECH: "ask" },
                },
                ask: {
